...
extern NSString* const MobservServiceCommon;
extern NSString* const MobservServiceUsers;
extern NSString* const MobservServiceBlobs;
extern NSString* const MobservServiceNotifier;
extern NSString* const MobservServiceGeopos;
extern NSString* const MobservServiceAuth;
extern NSString* const MobservServiceIM;
extern NSString* const MobservServiceHighscore;
extern NSString* const MobservServiceAdmin;
...
#define kBaseServicePageSizeNotSet 0

//#ifdef DEBUG
//#    define DLog(...) NSLog(__VA_ARGS__)
//#    define DL(...) [AsyncLogger LogF:[NSString stringWithFormat:__VA_ARGS__]] 
//#else
//#    define DLog(...) /* */
//#    define DL(...) /* */ 
//#endif
